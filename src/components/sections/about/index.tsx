        ...
        <>
            <Row>
                <Col md={6} xs={12}>
                    ...
                    <div>
                        <p>Hello everyone, my name is Trần Quốc Trung from Thái Bình, Vietnam.</p>

                        <p>I am currently working as a freelance developer and entrepreneur.</p>

                        <p>I hold an Engineering degree in Software Engineering from the University of Economics – Technology for Industries (UNETI).</p>
                    </div>
                    <div>
                                    ...
                                    <div className="experience-container">
                                        ...
                                        <div className="details">
                                            ...
                                            <div className="info">
                                                ...
                                                <p className="company">Hanoi University of Science and Technology (UNETI)</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
